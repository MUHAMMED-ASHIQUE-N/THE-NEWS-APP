...
onFilterChange(val)
  ...
  return (
    <div className='flex items-center justify-center gap-4 py-2 border-b border-gray-500 bg-blue-400 font-semibold text-white dark:border-gray-500 dark:text-white dark:bg-gray-900'>
